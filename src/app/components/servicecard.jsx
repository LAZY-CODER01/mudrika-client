...
const ServicesCard = () => {
  return (
    <div className=" grid grid-cols-4 mobile:grid-cols-12 xl:grid-cols-9 gap-5 mt-[30px] lg:mt-[55px] p-10">
      {services.map((item, index) => (
        <div
          key={index + 1}
          className="col-span-full mobile:col-span-6 md:col-span-4 lg:col-span-4 xl:col-span-3 border-2 black"
        >
          ...
          <div className="flex items-center justify-between mt-[30px]">
            ...
            > */}
              <BsArrowRight className="group-hover:text-white ml-3 text-[30px] bold" />{" "}
            {/* </Link> */}
            <span
